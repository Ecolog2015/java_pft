...
public class NewContact {
    ...
    public void testNewContact() throws Exception {
        goToNewContactPage();
        fillNewContactForm(new NewContactData("TestName", "TestMiddle", "TestName", "TestNickname", "TestCompany", "TestAddress", "45654", "654645", "456456", "456546"));
        submitNewContactCreation();
        returnToNewContactPage();
    }

    private void returnToNewContactPage() {
    ...
    private void fillNewContactForm(NewContactData newContactData) {
        ...
        wd.findElement(By.name("fax")).sendKeys(newContactData.getFaxphone());
    }
